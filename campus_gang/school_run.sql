...
-- ----------------------------
BEGIN;
INSERT INTO `admin` VALUES (1, '46', '123456', '孙贤超', '2021-11-08 09:16:25', 0);
COMMIT;
...
CREATE TABLE `class` (
  ...
  KEY `name` (`name`),
  CONSTRAINT `FK_CLASS_DEPT` FOREIGN KEY (`dept_id`) REFERENCES `dept` (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='通知公告表';
...
CREATE TABLE `sxc_remark` (
  ...
  `remark` varchar(50) DEFAULT NULL COMMENT '评价内容',
  ...
  CONSTRAINT `accept_id` FOREIGN KEY (`accept_id`) REFERENCES `user` (`id`),
  CONSTRAINT `publish_id` FOREIGN KEY (`publish_id`) REFERENCES `user` (`id`),
...
CREATE TABLE `sxc_student` (
  `id` int(30) NOT NULL AUTO_INCREMENT COMMENT '学生编号',
...
CREATE TABLE `task` (
  ...
  `accept_user_id` int(11) DEFAULT NULL COMMENT '接受任务用户id',
  ...
  CONSTRAINT `FK_TASK_ACCEPT_USER` FOREIGN KEY (`accept_user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_TASK_PUBLISH_USER` FOREIGN KEY (`publish_user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_TASK_USER_SCHOOL` FOREIGN KEY (`user_school_id`) REFERENCES `school` (`id`)
...
CREATE TABLE `user` (
  ...
  `school_id` int(11) NOT NULL COMMENT '学校id',
  `dept_id` int(11) DEFAULT NULL COMMENT '系别id',
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES (13, '1', '81dc9bdb52d04dc20036dbd8313ed055', '13332552233', 1, 1, 1, 0, '超哥', '2021-11-04 14:33:06', 76, 0);
INSERT INTO `user` VALUES (14, '46', 'e10adc3949ba59abbe56e057f20f883e', '18573743210', 1, 1, 1, 0, '孙贤超', '2021-11-08 09:01:53', 0, 0);
INSERT INTO `user` VALUES (15, '201801420246', 'e3a773feb6895dc44d3fd4472621fdda', '18573743210', 1, 1, 1, 0, '孙贤超', '2021-11-29 14:46:17', 0, 0);
