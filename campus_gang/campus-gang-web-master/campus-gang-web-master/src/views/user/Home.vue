        ...
        <div class="left" :style="{width:isCollapse?'64px':'200px',background:themeColor.bg,color:themeColor.color}" style="transition: .3s;">
            ...
            <el-menu
                ...
                <el-menu-item index="/home/">
                    ...
                    <span class="hvr-pulse">首页</span>
                </el-menu-item>
                
                <el-submenu index="4">
                    <template slot="title">
                        <i class="el-icon-office-building"></i>
                        <span class="hvr-grow-rotate">任务管理</span>
                    </template>
                        <el-menu-item index="/home/task">
                            <i class="el-icon-s-order"></i>
                            <span class="hvr-pop" >发布任务</span>
                        </el-menu-item>
                        <el-menu-item index="/home/accept">
                            <i class="el-icon-s-order"></i>
                            <span class="hvr-pop" >接受任务</span>
                        </el-menu-item>
                </el-submenu>
                ...
                <el-submenu index="5">
                    <template slot="title">
                        ...
                        <span class="hvr-grow-rotate">订单管理</span>
                    </template>
                        <el-menu-item index="/home/published">
                            <i class="el-icon-s-order"></i>
                            <span class="hvr-pop" >已发布任务</span>
                        </el-menu-item>
                        <el-menu-item index="/home/accepted">
                            <i class="el-icon-s-order"></i>
                            <span class="hvr-pop" >已接受任务</span>
                        </el-menu-item>
                </el-submenu>
                ...
                <el-submenu index="6">
                    <template slot="title">
                        ...
                        <span class="hvr-grow-rotate">公告管理</span>
                    </template>
                    <el-menu-item class="hvr-pop" index="/home/noticeu">查看公告
                    </el-menu-item>
                </el-submenu>
                ...
                <el-submenu index="7">
                    <template slot="title">
                        <i class="el-icon-s-custom"></i>
                        <span class="hvr-grow-rotate">评价管理</span>
                    </template>
                    <el-menu-item  class="hvr-pop" index="/home/myremark">我的评价
                    </el-menu-item>
                    <el-menu-item class="hvr-pop" index="/home/userremark">评价我的
                    </el-menu-item>
                </el-submenu>
                ...
                <el-submenu index="8">
                    <template slot="title">
                        <i class="el-icon-s-custom"></i>
                        <span class="hvr-grow-rotate">个人中心</span>
                    </template>
                    <el-menu-item class="hvr-pop" index="/home/MyProfile">个人信息
                    </el-menu-item>
                </el-submenu>
            </el-menu>
        </div>
