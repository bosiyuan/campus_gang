        ...
        <el-table 
            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                    <div v-if="scope.row.level === 1">
                        <el-button class="hvr-pop" icon="el-icon-plus" size="mini"
                        ...
                        <el-button class="hvr-buzz-out" icon="el-icon-delete" size="mini" type="danger"
            ...
            <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
                ...
                <div slot="footer" class="dialog-footer">
                    <el-button class="hvr-wobble-to-top-right" type="primary" @click="submit()">确 定</el-button>
