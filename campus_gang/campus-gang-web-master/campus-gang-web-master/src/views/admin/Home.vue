        ...
        <div class="left" :style="{width:isCollapse?'64px':'200px'}" style="transition: .3s;">
            ...
            <el-menu
                ...
                <el-menu-item index="/admin/home">
                    ...
                    <span class="hvr-skew-forward">首页</span>
                </el-menu-item>

                <el-submenu index="1">
                    <template slot="title">
                        <i class="el-icon-office-building"></i>
                        <span class="hvr-pulse-grow">学校管理</span>
                    </template>
                    <el-menu-item class="hvr-bounce-out" index="/admin/home/school">学校信息
                    </el-menu-item>
                </el-submenu>
                ...
                <el-submenu index="2">
                    <template slot="title">
                        <i class="el-icon-office-building"></i>
                        <span class="hvr-pulse-grow">角色管理</span>
                    </template>
                    <el-menu-item class="hvr-bounce-out" index="/admin/home/role">角色信息
                    </el-menu-item>
                </el-submenu>
                ...
                <el-submenu index="4">
                    <template slot="title">
                        ...
                        <span class="hvr-pulse-grow">用户管理</span>
                    </template>
                        <el-menu-item index="/admin/home/student">
                            <i class="el-icon-s-order"></i>
                            <span class="hvr-bounce-out">用户信息</span>
                        </el-menu-item>
                </el-submenu>
                ...
                <el-submenu index="5">
                    <template slot="title">
                        <i class="el-icon-s-order"></i>
                        <span class="hvr-pulse-grow">任务管理</span>
                    </template>
                        <el-menu-item index="/admin/home/task">
                            <i class="el-icon-s-order"></i>
                            <span class="hvr-bounce-out">任务信息</span>
                        </el-menu-item>
                </el-submenu>
                ...
                <el-submenu index="6">
                    <template slot="title">
                        <i class="el-icon-s-order"></i>
                        <span class="hvr-pulse-grow">评价管理</span>
                    </template>
                        <el-menu-item index="/admin/home/remark">
                            <i class="el-icon-s-order"></i>
                            <span class="hvr-bounce-out">评价信息</span>
                        </el-menu-item>
                </el-submenu>
                ...
                <el-submenu index="7">
                    <template slot="title">
                        ...
                        <span class="hvr-pulse-grow">公告管理</span>
                    </template>
                        <el-menu-item index="/admin/home/notice">
                            <i class="el-icon-s-order"></i>
                            <span class="hvr-bounce-out">系统公告</span>
                        </el-menu-item>
                </el-submenu>
